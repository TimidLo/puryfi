...
var OverlayScrollbarsGlobal = (function (t) {
   ...
   const type = (t) =>
      isUndefined(t) || isNull(t)
         ? `${t}`
         : p.call(t).replace(b, "$1").toLowerCase();
   ...
   const isArrayLike = (t) => {
      ...
      return isArray(t) || (!isFunction(t) && o)
         ? n > 0 && isObject(t)
            ? n - 1 in t
            : true
         : false;
   ...
   const removeUndefinedProperties = (t, n) =>
      each(assignDeep({}, t), (t, o, s) => {
         if (t === void 0) {
            delete s[o];
   ...
   const getDomTokensArray = (t) =>
      from(new Set((isArray(t) ? t : (t || "").split(" ")).filter((t) => t)));
   ...
   const liesBetween = (t, n, o) => {
      ...
      return s && e
         ? s === t || e === t || (c && closest(closest(t, o), n) !== s)
         : false;
   };
   ...
   const ratioToCssPercent = (t) =>
      `${(validFiniteNumber(t) * 100).toFixed(3)}%`;
   ...
   const getTrasformTranslateValue = (t, n) =>
      `translate${isObject(t) ? `(${t.x},${t.y})` : `${n ? "X" : "Y"}(${t})`}`;
   const k = {
      w: 0,
      h: 0,
   };
   const getElmWidthHeightProperty = (t, n) =>
      n
         ? {
              w: n[`${t}Width`],
              h: n[`${t}Height`],
   ...
   const convertScrollPosition = (t, n, o) =>
      o ? (o.n ? -t + 0 : o.i ? n - t : t) : t;
   const getRawScrollBounds = (t, n) => [
      convertScrollPosition(0, t, n),
      convertScrollPosition(t, t, n),
   ];
   const getRawScrollRatio = (t, n, o) =>
      capNumber(0, 1, convertScrollPosition(t, n, o) / n || 0);
   ...
   const getPropByPath = (t, n) =>
      t
         ? `${n}`
              .split(".")
              .reduce((t, n) => (t && hasOwnProperty(t, n) ? t[n] : void 0), t)
         : void 0;
   const P = {
   ...
   const createOptionCheck = (t, n, o) => (s) =>
      [getPropByPath(t, s), o || getPropByPath(n, s) !== void 0];
   ...
   const registerPluginModuleInstances = (t, n, o) =>
      keys(t).map((s) => {
   ...
   const Tt = /* @__PURE__ */ (() => ({
      [At]: {
         static: () => (t, n, o) => {
            ...
            const e = "scroll";
            const c = createDOM(
               `<div class="${it}" dir="ltr"><div class="${it}"><div class="${at}"></div></div><div class="${it}"><div class="${at}" style="width: 200%; height: 200%"></div></div></div>`
            );
            const r = c[0];
            const a = r.lastChild;
   ...
   const overflowisHidden = (t) => t.indexOf(A) === 0;
   ...
   const setViewportOverflowState = (t, n, o, s) => {
      ...
      const setAxisOverflowStyle = (t, n) => {
         const o = overflowisHidden(t);
         const s = o && e ? "hidden" : "";
         const c = (n && o && t.replace(`${A}-`, "")) || s;
         return [n && !o ? t : "", overflowisHidden(c) ? "hidden" : c];
      };
   ...
   const createEnvironment = () => {
      ...
      const getNativeScrollbarsHiding = (t) => {
         ...
         try {
            n =
               getStyles(t, "scrollbar-width") === "none" ||
               getStyles(t, "display", "::-webkit-scrollbar") === "none";
         } catch (s) {}
         o();
         return n;
      };
   ...
   const createSizeObserver = (t, n, o) => {
      ...
      return () => {
         const o = [];
         const u = createDOM(
            `<div class="${et}"><div class="${rt}"></div></div>`
         );
         const f = u[0];
         ...
         if (d) {
            ...
            push(
               o,
               concat(
                  [addClass(f, ct), addEventListener(f, "animationstart", t)],
                  n
               )
            );
         } else {
   ...
   const createTrinsicObserver = (t, n) => {
      let o;
      const isHeightIntrinsic = (t) =>
         t.h === 0 || t.isIntersecting || t.intersectionRatio > 0;
      ...
      const intersectionObserverCallback = (t, n) =>
         triggerOnTrinsicChangedCallback(n.pop(), t);
      return [
         () => {
            const n = [];
            if (_) {
   ...
   const createObserversSetup = (t, n, o, s) => {
      ...
      const k =
         !m &&
         createSizeObserver(b, onSizeChanged, {
            dt: true,
            _t: true,
         });
   ...
   const createScrollbarsSetupElements = (t, n, o, s) => {
      ...
      const m = dynamicInitializationElement(
         [i, u, f],
         () => (p && h ? i : u),
         l,
         b
      ...
      const addDirectionRTLKeyframes = (t, n) =>
         assignDeep(
            t,
            n
               ? {
      ...
      const scrollbarStructureRefreshHandleLength = (t, n) => {
         scrollbarStyle(t, (t) => {
            ...
            return [
               o,
               {
                  [n ? I : z]: ratioToCssPercent(
                     getScrollbarHandleLengthRatio(n)
                  ),
               },
            ];
         });
            ...
            each(t, (t) => {
               ...
               setElementAnimation(
                  ...
                  addDirectionRTLKeyframes(
                     {
                        transform: getRawScrollBounds(e, r).map((n) =>
                           getTransformValue(t, n, r)
                        ),
                     },
                     r
                  )
                  ...
                  if (doRefreshScrollbarOffset(o)) {
                     const setScrollbarElementAnimation = (t, s, e) => {
                        ...
                        setElementAnimation(
                           ...
                           addDirectionRTLKeyframes(
                              {
                                 transform: getRawScrollBounds(s - n, r).map(
                                    (t) =>
                                       getTrasformTranslateValue(
                                          numberToCssPx(t),
                                          e
      ...
      return (n, l, i, a) => {
         ...
         return bind(runEachAndClear, [
            ...
            addEventListener(
               u,
               "mousedown",
               bind(addEventListener, r, "click", stopPropagation, {
                  A: true,
                  I: true,
               }),
               {
   ...
   const createScrollbarsSetup = (t, n, o, s, e, c) => {
      ...
      const [C, x] = createScrollbarsSetupElements(
         t,
         e,
         s,
         createScrollbarsSetupEvents(n, e, s)
      );
   ...
   const createStructureSetupElements = (t) => {
      ...
      let ct = g
         ? X
         : contents(
              [tt, Z, G, Y, X].find((t) => elementIsGenerated(t) === false)
           );
      const rt = E ? X : tt || Z;
      ...
      const appendElements = () => {
         ...
         const prepareWrapUnwrapFocus = (t) =>
            t
               ? addEventListener(
                    t,
                    "focus blur",
         ...
         if (!z && y.top === y && t === p) {
            ...
            const revertViewportTabIndex = () =>
               n ? setAttrs(Z, t, n) : removeAttrs(Z, t);
   ...
   const createOverflowUpdateSegment = (t, n) => {
      ...
      return ({ Et: o, Zt: u, un: p, Tt: g }, { _n: E }) => {
         ...
         const rt = overflowisHidden(Z.x);
         const lt = overflowisHidden(Z.y);
         const it = rt || lt;
         let at = w(g);
         let ut = y(g);
         let ft = O(g);
      ...
      if (n && !r) {
         ...
         const y = {
            options(t, n) {
               if (t) {
                  const o = n ? s() : {};
                  const e = getOptionsDiff(
                     a,
                     assignDeep(o, validateOptions(t))
                  );
                  if (!isEmptyObject(e)) {
                     assignDeep(a, e);
                     g({
   ...
   OverlayScrollbars.plugin = (t) => {
      ...
      const o = n ? t : [t];
      const s = o.map(
         (t) => registerPluginModuleInstances(t, OverlayScrollbars)[0]
      );
      addPlugins(o);
      return n ? s : s[0];
   };
